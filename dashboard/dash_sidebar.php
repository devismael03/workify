					...
					<div class="dashboard-nav-inner">
						...
						<?php if(isfreelancer()){?>
                            <ul data-submenu-title="Frilanser">
                                ...
                                <li><a href="#"><i class="icon-material-outline-business-center"></i> Sizin xidmətləriniz</a>
                                    <ul>
                                        <li><a href="jobs_freelancer.php">Sizin xidmətlərinizin siyahısı<span class="nav-tag"><?php echo $countOfFreelancerJobs['count']; ?></span></a></li>
                                        <li><a href="add_job.php">Yeni xidmət</a></li>
                                    </ul>	
                                </li>
                                <li><a href="jobs_main.php"><i class="icon-material-outline-business-center"></i> Bütün xidmətlər</a></li>
