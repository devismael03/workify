					...
					<!-- Dashboard Box -->
						<div class="col-xl-12">
							<div class="dashboard-box margin-top-0">
								...
								<!-- Headline -->
								<div class="headline">
									<h3><i class="icon-material-outline-business-center"></i> Xidmət əlavə etmə formu</h3>
								</div>
								...
								<div class="content with-padding padding-bottom-10">
									<div class="row">
										...
										<div class="col-xl-12">
											<div class="submit-field">
												<h5>Xidmətinizə aid şəkillər(maksimum 4, minimum 1 şəkil (PNG,JPG))</h5>
