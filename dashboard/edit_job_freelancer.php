					...
					<!-- Dashboard Box -->
						<div class="col-xl-12">
							<div class="dashboard-box margin-top-0">
								...
								<!-- Headline -->
								<div class="headline">
									<h3><i class="icon-material-outline-business-center"></i> Xidmətə düzəliş etmə formu</h3>
								</div>
								...
								<div class="content with-padding padding-bottom-10">
									<div class="row">
										...
										<div class="col-xl-12">
											<div class="submit-field">
												<h5>Xidmətin görülə biləcəyi ərazilər</h5>
										...
										<div class="col-xl-12">
											<div class="submit-field">
												<h5>Xidmətinizə aid şəkillər(Ümumilikdə maksimum 4 şəkil olmalıdır, PNG,JPG)</h5>
												<div class="uploadButton margin-top-30">
													...
													<span class="uploadButton-file-name">Öncəki gördüyünüz xidmətlərdən nümunələr, və ya izahedici şəkillər.</span>
												</div>
											</div>
										</div>
