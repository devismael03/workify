					...
					<div class="dashboard-box margin-top-0">
						<?php if($balance['balance'] < $minimumBalance['minimum_balance']){ ?>
							<div class="notification error">
								<p><strong>Balansınız(<?= $balance['balance'].'AZN';?>) minimal balansdan(<?= $minimumBalance['minimum_balance'].'AZN';?>) az olduğu üçün xidmətləriniz axtarışda deaktivdir.</strong></p>
							</div>
						<?php } ?>
						
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-business-center"></i> Xidmətlər</h3>
							<br>
							<a href="add_job.php" class="button">Yeni xidmət <i class="icon-feather-plus"></i></a>
						</div>
						<br>
						<div class="content">
							...
							<table class="basic-table">
								...
								<?php while($job = $jobsQuery->fetch(PDO::FETCH_ASSOC)){ ?>
									<tr>
										<td data-label="Xidmət ID"><?php echo $job['job_id'];?></td>
										<td data-label="Xidmətin adı"><?php echo $job['job_title']; ?></td>
										...
										<td data-label="Xidmətə bax"><a href="view_job.php?&id=<?php echo $job['job_id'];?>" style="color:black;font-size:20px;"><i class="icon-feather-search"></a></i></td>
